...
import OtpVerificationScreen from './src/screens/auth/OtpVerificationScreen.js';
      ...
      <SafeAreaProvider>
        <NavigationContainer>
          ...
          >
            ...
            <Stack.Screen name="OtpVerificationScreen" component={OtpVerificationScreen} options={{ headerShown: false, title: 'Verification' }} />
            ...
            <Stack.Screen name="SuccessScreen" component={SuccessScreen} options={{ headerShown: false, title: 'Success' }} />
